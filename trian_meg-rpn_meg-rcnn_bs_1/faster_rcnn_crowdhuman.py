model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            '/mnt/lustre/yuyoujiang.vendor/trianing_tasks/test_dataset/resnet50_from_meg_2_torch.pth'
        )),
    neck=dict(
        type='FPN',
...
data_root = '/mnt/lustre/yuyoujiang.vendor/CrowdHuman/'
...
val_evaluator = dict(
    ...
    ann_file='/mnt/lustre/yuyoujiang.vendor/CrowdHuman/annotation_val.odgt',
    metric=['AP', 'MR'])
test_evaluator = dict(
    type='CrowdHumanMetric',
    ann_file='/mnt/lustre/yuyoujiang.vendor/CrowdHuman/annotation_val.odgt',
...
log_level = 'INFO'
load_from = '/mnt/lustre/yuyoujiang.vendor/trianing_tasks/test_dataset/pretrained.pth'
resume = False
launcher = 'slurm'
work_dir = ''
